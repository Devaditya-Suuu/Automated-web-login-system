...
try:
    ...
    login_button = WebDriverWait(driver, 2).until(
        EC.visibility_of_element_located((By.XPATH, "/html/body/div/div/div[4]/div[2]/div"))  #make shure to enter the xpath of the login button by going through the inspect mode
    )
